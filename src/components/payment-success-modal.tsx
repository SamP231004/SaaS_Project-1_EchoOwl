...
export const PaymentSuccessModal = () => {
    ...
    const { data: planData } = useQuery<{ plan: Plan }>({
  queryKey: ["user-plan"],
  queryFn: async () => {
    ...
    const isPaymentSuccessful = planData?.plan === PLANS.PRO
                    ...
                    <>
                        ...
                        <div className="mt-6 flex flex-col items-center gap-1 text-center">
                            ...
                            <p className="text-gray-600 text-sm/6 text-pretty">
                                Thank you for upgrading to Pro and supporting EchoOwl. Your
